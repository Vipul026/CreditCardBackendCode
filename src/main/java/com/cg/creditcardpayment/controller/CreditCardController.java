...
public class CreditCardController {
	...
	public ResponseEntity<CreditCard> updateCreditCard(@RequestBody @Valid CreditCard creditCard,@PathVariable String cardNumber,BindingResult bindingResult) throws CreditCardException{
		...
		{
			creditCard =creditCardService.updateCreditCard(creditCard,cardNumber);
